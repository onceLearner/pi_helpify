...
const ModalAjouter = ({ openModalHook, setListDemandes, listDemandes, userInfo, setRefresh }) => {
    ...
    return (
        <div >
            ...
            <div className={`fided z-30 top-12 md:right-20 md:left-20 left-10 right-10 bg-white flex flex-col p-3  transform scale-${ModalScale}  transition-transform ease-in rounded-xl`} style={{ transitionDuration: "200ms" }}>
