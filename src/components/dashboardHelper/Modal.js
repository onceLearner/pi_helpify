...
const Modal = ({ openModalHook, data, color, text }) => {
    ...
    return (
        <div >
            ...
            <div className={`fixed z-30 top-72 md:right-1/4 md:left-1/4 left-10 right-10 bg-white flex flex-col p-3  transform scale-${ModalScale}  transition-transform ease-in rounded-xl`} style={{ transitionDuration: "200ms" }}>
                ...
                <div className=" flex flex-wrap justify-center   p-2 mt-4 ">
                    ...
                    <button onClick={() => setOpenModal(false)} className={`p-2 mx-2  w-40 bg-gray-200 hover:opacity-50 text-gray-600 rounded-3xl`}>Annuler</button>
                </div>
